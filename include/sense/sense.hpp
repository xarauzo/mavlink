/** @file
 *	@brief MAVLink comm protocol generated from sense.xml
...
/** @brief Status flags for DAA Pipeline status */
...
//! PIPELINE_STATE ENUM_END
constexpr auto PIPELINE_STATE_ENUM_END = 2;

/** @brief Type of avoidance maneuver */
enum class MANEUVER_TYPE : uint8_t
{
    UPWARDS=0, /*  | */
    RIGHT_DODGE=1, /*  | */
};

//! MANEUVER_TYPE ENUM_END
constexpr auto MANEUVER_TYPE_ENUM_END = 2;

/** @brief Threat level definition based on distance and other metrics. */
enum class SENSE_THREAT_LEVEL : uint16_t
{
    NONE=0, /*  | */
    DETECTED=1, /*  | */
    NEAR=2, /*  | */
...
//! SENSE_THREAT_LEVEL ENUM_END
constexpr auto SENSE_THREAT_LEVEL_ENUM_END = 4;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_sense_heartbeat.hpp"
#include "./mavlink_msg_sense_time.hpp"
#include "./mavlink_msg_sense_ar.hpp"
#include "./mavlink_msg_sense_daa.hpp"
#include "./mavlink_msg_sense_state_vector.hpp"
#include "./mavlink_msg_sense_av_man.hpp"
